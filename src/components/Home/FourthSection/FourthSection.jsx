        ...
        <div>
            <Row gutter={[50,50]} align="middle" justify="center">
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/server.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/soft-skills.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/money-growth.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/pottery.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/cooking.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/bullhorn.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/pharmacy.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/guitar.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/language.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/workout.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/tripod.png" alt="skills" height={120} width={120}/>
                        </div>
                ...
                <Col lg={4}>
                    <div className={styles.card}>
                        <div className={styles.img_wrapper}>
                            <Image src="/images/inspiration.png" alt="skills" height={120} width={120}/>
                        </div>
