      ...
      <div className={styles.container}>
        ...
        <div className={styles.card_wrapper_1}>
          ...
          <div className={styles.card_1}>
            <div>
                <h1 className="text-gray-400 text-xl text-center">Gói hàng tháng</h1>
                <h1 className="text-2xl font-bold text-center my-2">đ300.000</h1>
                <p className="text-center text-xs">Mỗi tháng, thanh toán hàng tháng</p>
                ...
                <div className="flex gap-5 my-3">
                    ...
                    <div>
                        <h3>Bán khóa học</h3>
                        <p className="text-xs">( không giới hạn số lượng, lĩnh vực )</p>
                    </div>
                </div>
                {/*  */}
        ...
        <div className={styles.card_wrapper_2}>
          ...
          <div className={styles.card_1}>
            <div>
                <h1 className="text-gray-400 text-xl text-center">Gói hàng năm</h1>
                <h1 className="text-2xl font-bold text-center my-2">đ230.000</h1>
                <p className="text-center text-xs">Mỗi tháng, thanh toán hàng năm</p>
...
export default MentorPackagePage;
